...
const DataSet = {
  SORT_DIRECTION: 'sortDirection', // data-sort-direction
  SORT_VALUE: 'sortValue', // data-sort-value
  SORT_TYPE: 'sortType', // data-sort-type
};
...
export default class ElementUtil {
  ...
  static _resolveBase(base) {
    return base === document ? base : this.getElement(base);
  }
